...
/*
Most successful teams per match in their homes (winning percentange)
*/
...
/*
Matches with the highest ball possession
*/
...
SELECT
    ...
    ROUND(AVG(home_team_goal+away_team_goal),2) AS total_goals,
    ROUND(AVG(home_team_goal),2) AS home_goals,
    ROUND(AVG(away_team_goal),2) AS away_goals
FROM match 
GROUP BY years
